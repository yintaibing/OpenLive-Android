...
import com.zhenai.android.utils.record_screen.biz.RecordScreenLayout;
...
public class LiveRoomActivity extends BaseActivity implements AGEventHandler {
    ...
    protected void initUIandEvent() {
        ...
        RecordScreenLayout recordScreenLayout = (RecordScreenLayout) findViewById(R.id.layout_record_screen);
...
//        addMediaPreProcessing();
    ...
    private void addMediaPreProcessing() {
        ...
        plugin.addAudioObserver(new MediaDataAudioObserver() {
            @Override
            public void onRecordAudioFrame(byte[] data, int videoType, int samples, int bytesPerSample, int channels, int samplesPerSec, long renderTimeMs, int bufferLength) {
                Log.e("onRecordAudioFrame", ""+bufferLength);
            }
            ...
            public void onPlaybackAudioFrame(byte[] data, int videoType, int samples, int bytesPerSample, int channels, int samplesPerSec, long renderTimeMs, int bufferLength) {
                Log.e("onPlaybackAudioFrame", ""+bufferLength);
            }
            ...
            public void onPlaybackAudioFrameBeforeMixing(byte[] data, int videoType, int samples, int bytesPerSample, int channels, int samplesPerSec, long renderTimeMs, int bufferLength) {
                Log.e("onBeforeMixing", ""+bufferLength);
            }
            ...
            public void onMixedAudioFrame(byte[] data, int videoType, int samples, int bytesPerSample, int channels, int samplesPerSec, long renderTimeMs, int bufferLength) {
                Log.e("onMixedAudioFrame", ""+bufferLength);
            }
        });

        MediaPreProcessing.setAudioRecordByteBUffer(plugin.byteBufferAudioRecord);
        MediaPreProcessing.setAudioPlayByteBUffer(plugin.byteBufferAudioPlay);
        MediaPreProcessing.setAudioMixByteBUffer(plugin.byteBufferAudioMix);
        MediaPreProcessing.setBeforeAudioMixByteBUffer(plugin.byteBufferBeforeAudioMix);

        MediaPreProcessing.setCallback(plugin);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        mRecordScreenManager.onActivityResult(this, requestCode, resultCode, data);
    }
